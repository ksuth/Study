...
<form action="${flowExecutionUrl}" method="post">
    ...
    <input type="text" name="userName" id="userName" value="shuyuq"/>
    <input type="password" name="password" id="password" value="wsyq111"/>
    <input type="hidden" name="test" value="test1111"/>
